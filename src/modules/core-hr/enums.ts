...
export const LIFECYCLE_EVENT_TYPES = ["hire", "rehire", "probation_pass", "probation_fail", "contract_renewal", "transfer", "promotion", "salary_change", "pay_profile_change", "discipline", "reward", "long_leave", "resignation", "termination"] as const;
