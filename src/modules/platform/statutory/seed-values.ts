...
export const STATUTORY_SEED: Seed[] = [
  ...
  { key: "union.dues_cap", validFrom: "2026-01-01", value: { referenceLevelShare: 1000 }, legalReference: "Quyết định 1908/QĐ-TLĐ, Điều 23 — verify against the current union charter guidance", note: "Monthly member dues are capped at 10% of the reference level (mức lương cơ sở)." },
  { key: "insurance.unpaid_leave_threshold", validFrom: "2026-01-01", value: { workingDays: 14 }, legalReference: "Luật BHXH 2024 — verify the article and the guiding decree", note: "No compulsory insurance for a month with 14 or more unpaid working days; the month does not count towards the contribution record." },
  { key: "pit.overtime_exemption", validFrom: "2026-01-01", value: { mode: "premium_only" }, legalReference: "Thông tư 111/2013/TT-BTC, Điều 3.1.i — Luật Thuế TNCN sửa đổi 109/2025/QH15 is reported to widen this; verify the guidance", note: "premium_only: only the part of overtime and night pay above ordinary-hours pay is exempt. Switch to full once the guidance for the amended law is confirmed (SRS Appendix A)." },
