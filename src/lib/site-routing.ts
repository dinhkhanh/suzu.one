 ...
 * themselves (`/api/auth/`, `/api/cron/`) or are the installable app's own files. On the public
 * domain they do not exist.
 */
const APP_PASS_THROUGH = ["/api/auth/", "/api/cron/", "/sw.js", "/offline.html", "/manifest.webmanifest"];
